...
Tags: visit log, visits, log, user visits, statistics, visit stats, : analytics, analyze, reports, stats, tracker, tracking
...
[Github Repo](https://github.com/rilwis/user-visit-log/)

== Installation ==

1. Unzip the download package
1. Upload `user-visit-log` to the `/wp-content/plugins/` directory
